$(window).scroll(function () {
  ...
  } else if (scrollValue >= 14000 && scrollValue <= 15500) {
    setTimeout(function () {
      console.log($(".eleventh-wrapper #devices"));
      $(".eleventh-wrapper #devices").fadeIn(1000);
      $(".eleventh-wrapper #devices").animate({ marginTop: "0" }, 500);
