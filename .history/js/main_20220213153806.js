$(window).scroll(function () {
  ...
  } else if (scrollValue >= 10900 && scrollValue <= 10100) {
    $(".third-cont img").css("opacity", "0.2");
  } else if (scrollValue >= 11000 && scrollValue <= 12000) {
    $(".third-cont img").css("opacity", "0.5");
  } else if (scrollValue >= 12000 && scrollValue <= 13000) {
    $(".third-cont img").css("opacity", "0.8");
  } else if (scrollValue >= 13000 && scrollValue <= 14000) {
